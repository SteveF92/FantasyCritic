    ...
    internal static class LeagueFactory
    {
        ...
        public static List<LeagueYear> GetLeagueYears()
        {
            ...
            foreach (var league in leagues)
            {
                ...
                LeagueYear year = new LeagueYear(league, 2019, new LeagueOptions(12, 6, 1, 2, -1, 0, false, eligibilitySettings, new List<LeagueTagOption>(),  DraftSystem.Flexible, PickupSystem.Budget, 
