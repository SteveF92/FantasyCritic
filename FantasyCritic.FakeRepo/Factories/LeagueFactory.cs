    ...
    internal static class LeagueFactory
    {
        ...
        public static List<LeagueYear> GetLeagueYears()
        {
            ...
            foreach (var league in leagues)
            {
                ...
                LeagueYear year = new LeagueYear(league, GetSupportedYear(2019), new LeagueOptions(12, 6, 1, 2, 2, -1, 0, false, false, 0, new List<LeagueTagStatus>(),  DraftSystem.Flexible, PickupSystem.SecretBidding, 
