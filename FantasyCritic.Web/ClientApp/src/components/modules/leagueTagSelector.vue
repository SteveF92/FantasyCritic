<template>
  <div>
    ...
    <div class="alert alert-danger" v-show="showDanger && !showPortDanger">The settings you have selected are REALLY not recommended, unless you really know what you are doing and want a highly custom league.</div>
