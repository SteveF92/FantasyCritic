    ...
    public class PublisherViewModel
    {
            ...
            bool userIsInLeague, bool outstandingInvite, SystemWideValues systemWideValues, bool yearFinished)
        {
            ...
            GameSlots = publisher.GetPublisherSlots()
                .Select(x => new PublisherSlotViewModel(publisher.LeagueYear.Year, x, currentDate, publisher.LeagueYear, publisher.LeagueYear.Options.ScoringSystem, systemWideValues))
                .ToList();
