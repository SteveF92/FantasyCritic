...
namespace FantasyCritic.Web.Models.Responses
{
    ...
    {
        public PublisherSlotViewModel(PublisherSlot slot, LocalDate currentDate, MasterGameEligibilityFactors eligibilityFactors, SystemWideValues systemWideValues)
        {
