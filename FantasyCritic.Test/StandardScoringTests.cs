...
namespace FantasyCritic.Test
{
    ...
    public class StandardScoringTests
    {
        ...
        public void BasicScoreTest()
        {
            ...
            MasterGame masterGame = new MasterGame(Guid.NewGuid(), "", "", new LocalDate(2018, 7, 13), new LocalDate(2018, 7, 13), null, 84.8095m, 2018, eligibilitySettings, "", 
        ...
        public void ManualScoreTest()
        {
            ...
            MasterGame masterGame = new MasterGame(Guid.NewGuid(), "", "", new LocalDate(2018, 7, 13), new LocalDate(2018, 7, 13), null, null, 2018, eligibilitySettings, "", 
                fakeClock.GetCurrentInstant(), false, false, fakeClock.GetCurrentInstant());
        ...
        public void Over90ScoreTest()
        {
            ...
            MasterGame masterGame = new MasterGame(Guid.NewGuid(), "", "", new LocalDate(2018, 4, 20), new LocalDate(2018, 4, 20), null, 94.8125m, 2018, eligibilitySettings, "", 
                fakeClock.GetCurrentInstant(), false, false, fakeClock.GetCurrentInstant());
            PublisherGame testGame = new PublisherGame(Guid.NewGuid(), Guid.NewGuid(), "", pickupTime, false, null, null, new MasterGameYear(masterGame, 2018), null, null, 2018);
        ...
        public void Under70ScoreTest()
        {
            ...
            MasterGame masterGame = new MasterGame(Guid.NewGuid(), "", "", new LocalDate(2018, 4, 20), new LocalDate(2018, 4, 20), null, 65.8559m, 2018, eligibilitySettings, "", 
                fakeClock.GetCurrentInstant(), false, false, fakeClock.GetCurrentInstant());
            PublisherGame testGame = new PublisherGame(Guid.NewGuid(), Guid.NewGuid(), "", pickupTime, false, null, null, new MasterGameYear(masterGame, 2018), null, null, 2018);
        ...
        public void UnreleasedGameTest()
        {
            ...
            MasterGame masterGame = new MasterGame(Guid.NewGuid(), "", "", new LocalDate(2018, 10, 20), new LocalDate(2018, 10, 20), null, null, 2018, eligibilitySettings, "", 
                fakeClock.GetCurrentInstant(), false, false, fakeClock.GetCurrentInstant());
            PublisherGame testGame = new PublisherGame(Guid.NewGuid(), Guid.NewGuid(), "", pickupTime, false, null, null, new MasterGameYear(masterGame, 2018), null, null, 2018);
        ...
        public void WillNotReleaseGameTest()
        {
            ...
            MasterGame masterGame = new MasterGame(Guid.NewGuid(), "", "", new LocalDate(2018, 10, 20), new LocalDate(2018, 10, 20), null, null, 2019, eligibilitySettings, "", 
                fakeClock.GetCurrentInstant(), false, false, fakeClock.GetCurrentInstant());
            PublisherGame testGame = new PublisherGame(Guid.NewGuid(), Guid.NewGuid(), "", pickupTime, false, null, null, new MasterGameYear(masterGame, 2018), null, null, 2018);
