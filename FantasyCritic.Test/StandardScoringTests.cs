...
namespace FantasyCritic.Test
{
    ...
    public class StandardScoringTests
    {
        ...
        public void BasicScoreTest()
        {
            ...
            PublisherGame testGame = new PublisherGame(Guid.NewGuid(), "", pickupTime, false, null, null, masterGame, 2018);
        ...
        public void ManualScoreTest()
        {
            ...
            PublisherGame testGame = new PublisherGame(Guid.NewGuid(), "", pickupTime, false, 83.8095m, null, masterGame, 2018);
        ...
        public void CounterPickGameTest()
        {
            ...
            MasterGame masterGame = new MasterGame(Guid.NewGuid(), "", "", new LocalDate(2018, 4, 20), null, 65.8559m, 2018, StandardEligibilityLevel, false, false, "");
            PublisherGame testGame = new PublisherGame(Guid.NewGuid(), "", pickupTime, true, null, null, masterGame, 2018);
