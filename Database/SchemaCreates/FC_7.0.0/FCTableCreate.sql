...
-- Dumping structure for table fantasycritic.tbl_discord_notablemissoptions
CREATE TABLE IF NOT EXISTS `tbl_discord_notablemissoptions` (
...
-- Dumping structure for table fantasycritic.tbl_royale_publisherstatistics
CREATE TABLE IF NOT EXISTS `tbl_royale_publisherstatistics` (
  `PublisherID` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `Date` date NOT NULL,
  `FantasyPoints` decimal(12,4) NOT NULL,
  PRIMARY KEY (`PublisherID`,`Date`) USING BTREE,
  CONSTRAINT `FK_tbl_royale_publisherstatistics_tbl_royale_publisher` FOREIGN KEY (`PublisherID`) REFERENCES `tbl_royale_publisher` (`PublisherID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC;
...
CREATE TABLE IF NOT EXISTS `tbl_royale_supportedquarter` (
  ...
  `OpenForPlay` bit(1) NOT NULL,
  `Finished` bit(1) NOT NULL,
  `WinningUser` char(36) DEFAULT NULL,
