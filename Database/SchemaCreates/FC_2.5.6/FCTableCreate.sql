...
CREATE TABLE IF NOT EXISTS `tbl_caching_mastergameyear` (
  ...
  CONSTRAINT `FK_tbl_caching_mastergameyear_tbl_user` FOREIGN KEY (`AddedByUserID`) REFERENCES `tbl_user` (`UserID`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE IF NOT EXISTS `tbl_league_publisher` (
  ...
  `SuperDropsAvailable` int(10) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `tbl_league_specialauction` (
  ...
  CONSTRAINT `FK_tbl_league_specialauction_tbl_league_year` FOREIGN KEY (`LeagueID`, `Year`) REFERENCES `tbl_league_year` (`LeagueID`, `Year`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_tbl_league_specialauction_tbl_mastergame` FOREIGN KEY (`MasterGameID`) REFERENCES `tbl_mastergame` (`MasterGameID`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE IF NOT EXISTS `tbl_league_year` (
  ...
  `CounterPickDeadlineMonth` tinyint(3) NOT NULL,
  `CounterPickDeadlineDay` tinyint(3) NOT NULL,
  `Timestamp` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  ...
  CONSTRAINT `FK_tbl_league_year_tbl_settings_tiebreaksystem` FOREIGN KEY (`TiebreakSystem`) REFERENCES `tbl_settings_tiebreaksystem` (`TiebreakSystem`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `tbl_mastergame` (
  ...
  CONSTRAINT `FK_tbl_mastergame_tbl_user` FOREIGN KEY (`AddedByUserID`) REFERENCES `tbl_user` (`UserID`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE IF NOT EXISTS `tbl_mastergame_changelog` (
  ...
  CONSTRAINT `FK__tbl_mastergame` FOREIGN KEY (`MasterGameID`) REFERENCES `tbl_mastergame` (`MasterGameID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK__tbl_user` FOREIGN KEY (`ChangedByUserID`) REFERENCES `tbl_user` (`UserID`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `vw_league` (
	...
	`NumberOfFollowers` BIGINT(21) NOT NULL,
	`IsDeleted` BIT(1) NOT NULL
) ENGINE=MyISAM;
...
CREATE TABLE `vw_league_pickupbid` (
	...
	`ConditionalDropGameName` VARCHAR(255) NULL COLLATE 'utf8mb4_general_ci',
	`CounterPick` BIT(1) NOT NULL,
	`Priority` INT(11) NOT NULL,
	`BidAmount` INT(11) UNSIGNED NOT NULL,
	`Successful` BIT(1) NULL,
...
CREATE TABLE `vw_meta_sitecounts` (
	`UserCount` BIGINT(21) NOT NULL,
	`LeagueCount` BIGINT(21) NOT NULL,
	`MasterGameCount` BIGINT(21) NOT NULL,
	`PublisherGameCount` BIGINT(21) NOT NULL
) ENGINE=MyISAM;
