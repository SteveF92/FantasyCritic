...
) ENGINE=InnoDB AUTO_INCREMENT=985995 DEFAULT CHARSET=utf8mb4;
...
) ENGINE=InnoDB AUTO_INCREMENT=14895 DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `vw_league` (
	...
	`LeagueName` VARCHAR(150) NOT NULL,
	`LeagueManager` CHAR(36) NOT NULL,
	`ConferenceID` CHAR(36) NULL,
	`ConferenceName` VARCHAR(150) NULL,
...
CREATE TABLE `vw_league_pickupbid` (
	...
	`MasterGameID` CHAR(36) NOT NULL,
	`GameName` VARCHAR(255) NOT NULL,
	`ConditionalDropMasterGameID` CHAR(36) NULL,
	`CounterPick` BIT(1) NOT NULL,
