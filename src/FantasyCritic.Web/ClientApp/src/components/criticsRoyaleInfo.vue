<template>
  <div>
    ...
    <div v-if="is2026Q3Plus">
      ...
      <div class="text-well">
        <p>We are continuing to refine the rule set for Critic's Royale. Here's a list of this quarter's changes.</p>
        <ul>
          <li>Ad budget is back to giving a 5% boost per dollar, for a total possible boost of 50%.</li>
          <li>
            The rules for selling a game have been reverted to be closer to what they were pre-2026. Now, selling a game gets you back 50% of what you spent (plus any advertising budget assigned). If
            a game has been delayed out of the quarter, you instead get 75%, and if a game has been deemed ineligible in Royale, you get a full refund.
          </li>
        ...
        <p>
          Note that these rule changes
          <em>do not</em>
          affect Q2 of 2026. Those rules are locked in.
        </p>
      </div>
    </div>
    ...
    <div v-if="is2026Q1Q2">
      ...
      <div class="text-well">
        <p>There have been several changes for the 2026 seasons. All of the information here is also elsewhere on this page, but here's a short summary of what's changed this year:</p>
        <ul>
    ...
    <div v-if="is2026Q1Q2">
      ...
      <div class="text-well">
        <p>
          You'll be given a $100 "budget" with which to "buy" games to add them to your roster. There is a roster limit of 15 games per quarter. Each game's price is set based upon how popular it is
          on the site. When the game releases, you get points using the same system as the regular Fantasy Critic leagues. You can also boost your points by setting an "advertising budget" for a game
    ...
    <div v-if="is2026Q3Plus">
      ...
      <div class="text-well">
        ...
        <p>
          If you lose confidence in a game, you can choose to "sell" it, and get back half of what you paid for it (plus any advertising budget you assigned). If a game is confirmed to not release in
          the quarter, you get back 75% of what you paid. If a game is deemed ineligible in Royale, you get a full refund. You can't sell a game that has come out, or one that has reviews already.
        </p>
        <p>There is also a 10 minute "regret window" after purchasing a game during which you can sell it back for exactly what you paid.</p>
      </div>
    </div>
    ...
    <div v-if="is2026Q3Plus">
      ...
      <div class="text-well">
        ...
        <p>
          ...
          reviews starting to come in. In the case of "Shadow Drops", if you purchased the game the day before the game was revealed, you can keep it, but if you purchase it the same day as the reveal
          + release, then it will be marked as ineligible once the release date is set correctly in the system.
        </p>
