...
public class ConferenceService
{
    ...
    public async Task<Result<Conference>> CreateConference(ConferenceCreationParameters parameters)
    {
        ...
        IEnumerable<MinimalLeagueYearInfo> leagueYears = new List<MinimalLeagueYearInfo>() { new MinimalLeagueYearInfo(parameters.LeagueYearParameters.Year) };
    ...
    public async Task<Result> AddLeagueToConference(Conference conference, int year, string leagueName, FantasyCriticUser leagueManager)
    {
        ...
        IEnumerable<MinimalLeagueYearInfo> leagueYears = new List<MinimalLeagueYearInfo>() { new MinimalLeagueYearInfo(year) };
