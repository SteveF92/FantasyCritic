...
internal class LeagueGameChannelScoredGameIsRelevantTests : LeagueGameNewsChannelTests
{
    ...
    public void ScoredGame_Eligible_ReleasedToday_LeagueGames_Off_Misses_On_SettingOff_NoSkippedTags_HasGame_Score90() =>
        Assert.That(LeagueGames_Off_Misses_On_SettingOff_NoSkippedTags(GetTestLeagueYear(true)).ScoredGameIsRelevant(Eligible_ReleasedToday, null, 90m, CurrentDateForTesting), Is.True);
    ...
    public void ScoredGame_Eligible_ReleasedToday_LeagueGames_Off_Misses_On_SettingOff_SkipUNA_HasGame_Score90() =>
        Assert.That(LeagueGames_Off_Misses_On_SettingOff_SkipUNA(GetTestLeagueYear(true)).ScoredGameIsRelevant(Eligible_ReleasedToday, null, 90m, CurrentDateForTesting), Is.True);
    ...
    public void ScoredGame_Eligible_ReleasedToday_LeagueGames_Off_Misses_On_SettingOff_NoSkippedTags_DoesNotHaveGame_Score90() =>
        Assert.That(LeagueGames_Off_Misses_On_SettingOff_NoSkippedTags(GetTestLeagueYear(false)).ScoredGameIsRelevant(Eligible_ReleasedToday, null, 90m, CurrentDateForTesting), Is.True);
    ...
    public void ScoredGame_Ineligible_ReleasedToday_LeagueGames_Off_Misses_On_SettingMightReleaseInYear_NoSkippedTags_DoesNotHaveGame_Score75() =>
        Assert.That(LeagueGames_Off_Misses_On_SettingMightReleaseInYear_NoSkippedTags(GetTestLeagueYear(false)).ScoredGameIsRelevant(Ineligible_ReleasedToday, null, 75m, CurrentDateForTesting), Is.False);
    ...
    public void ScoredGame_Ineligible_ReleasedToday_LeagueGames_Off_Misses_Off_SettingMightReleaseInYear_NoSkippedTags_DoesNotHaveGame_Score75() =>
        Assert.That(LeagueGames_Off_Misses_Off_SettingMightReleaseInYear_NoSkippedTags(GetTestLeagueYear(false)).ScoredGameIsRelevant(Ineligible_ReleasedToday, null, 75m, CurrentDateForTesting), Is.False);
    ...
    public void ScoredGame_Ineligible_ReleasedToday_LeagueGames_Off_Misses_On_SettingMightReleaseInYear_NoSkippedTags_DoesNotHaveGame_Score90() =>
        Assert.That(LeagueGames_Off_Misses_On_SettingMightReleaseInYear_NoSkippedTags(GetTestLeagueYear(false)).ScoredGameIsRelevant(Ineligible_ReleasedToday, null, 90m, CurrentDateForTesting), Is.False);
    ...
    public void ScoredGame_Ineligible_ReleasedToday_LeagueGames_Off_Misses_Off_SettingMightReleaseInYear_NoSkippedTags_DoesNotHaveGame_Score90() =>
        Assert.That(LeagueGames_Off_Misses_Off_SettingMightReleaseInYear_NoSkippedTags(GetTestLeagueYear(false)).ScoredGameIsRelevant(Ineligible_ReleasedToday, null, 90m, CurrentDateForTesting), Is.False);
