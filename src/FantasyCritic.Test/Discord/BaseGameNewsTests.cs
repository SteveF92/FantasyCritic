...
internal abstract class BaseGameNewsTests
{
    ...
    public static LeagueYear GetTestLeagueYear(bool includeGame)
    {
        ...
        if (includeGame)
        {
            ...
            games.Add(new PublisherGame(Guid.Empty, Guid.Empty, "Game", Instant.MinValue, false, null, false, null, gameYear, 1, 1, 1, null, null, null));
        }
        ...
        return new LeagueYear(league, supportedYear, leagueOptions, [leagueDraft],
