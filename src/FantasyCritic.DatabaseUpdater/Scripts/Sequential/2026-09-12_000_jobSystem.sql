...
INSERT INTO `tbl_job_type` (`Name`, `DisplayName`, `Category`, `Severity`, `RunType`) VALUES
	...
	('PushPublicBiddingMessages', 'Push Public Bidding Messages', 'Other', 'Danger', 'ManualOrCron'),
	...
	('SendPublicBiddingEmails', 'Send Public Bidding Emails', 'Other', 'Danger', 'ManualOrCron'),
