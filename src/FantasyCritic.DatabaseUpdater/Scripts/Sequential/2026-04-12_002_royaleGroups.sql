CREATE TABLE IF NOT EXISTS `tbl_royale_group` (
  ...
  `GroupType` tinyint NOT NULL COMMENT '0=Manual, 1=RulesBased, 2=LeagueTied, 3=ConferenceTied',
...
VALUES (UUID(), 'Previous Royale Winners', NULL, 1, NULL, NULL, 'PreviousWinners', UTC_TIMESTAMP());
